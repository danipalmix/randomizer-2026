...
describe('contratto visuale', () => {
  ...
  it('include controlli professionali del grafo', () => { for (const label of ['Modalità avanzata', 'Anteprima rapida', 'Distribuisci equamente', 'Normalizza a 100%', 'Aggiungi asset personalizzato', 'Collega i layer nell’ordine']) expect(organize).toContain(label); });
});
